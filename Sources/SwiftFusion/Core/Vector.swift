...
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 22)

/// An element of R^1, with Euclidean norm.
public struct Vector1: Differentiable, KeyPathIterable, TangentStandardBasis
{
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 27)
  @differentiable public var x: Double
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 29)

  @differentiable
  public init(_ x: Double) {
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 33)
    self.x = x
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 35)
  }
}
...
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 65)
  ...
  public static prefix func - (_ v: Self) -> Self {
    var result = Self.zero
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 72)
    result.x = -v.x
...
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 86)
  ...
  public func squared() -> Self {
    var result = Self.zero
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 93)
    result.x = x * x
...
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 105)
    var basisx: Self = .zero
    basisx.x = 1
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 108)
    return [basisx]
  }
...
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 118)
...
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 139)
    self.x = tensor[0].scalarized()
// ###sourceLocation(file: "Sources/SwiftFusion/Core/Vector.swift.gyb", line: 141)
  }
}
